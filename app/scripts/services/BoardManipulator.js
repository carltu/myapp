...
angular.module('myappApp').factory('BoardManipulator', function () {
  return {
    ...
    addCardToColumn: function (board, column, cardTitle, details, id) {
      angular.forEach(board.columns, function (col) {
        if (col.name === column.name) {
          col.cards.push(new Card(id, cardTitle, column.name, details));
        }
      });
    },
